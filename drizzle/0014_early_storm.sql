...
INSERT INTO `__new_message`("id", "textContent", "sender", "model", "status", "thread") SELECT "id", "textContent", "sender", "model", "status", "thread" FROM `message`;--> statement-breakpoint
