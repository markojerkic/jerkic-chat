/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: ba860aa146dbaa849363e2d2230a9b1f)
// Runtime types generated with workerd@1.20260312.1 2025-04-04 no_handle_cross_request_promise_resolution,nodejs_compat
declare namespace Cloudflare {
  interface GlobalProps {
    mainModule: typeof import("./src/app");
    durableNamespaces: "MessagesDurableObject" | "ChatSession" | "UserData";
  }
  interface Env {
    CHAT_CACHE: KVNamespace;
    upload_files: R2Bucket;
    DB: D1Database;
    OPEN_ROUTER_KEY: string;
    GITHUB_CLIENT_ID: string;
    GITHUB_CLIENT_SECRET: string;
    WEBSOCKET_SERVER: DurableObjectNamespace<
      import("./src/app").MessagesDurableObject
    >;
    SESSION_DO: DurableObjectNamespace<import("./src/app").ChatSession>;
    USER_DATA_DO: DurableObjectNamespace<import("./src/app").UserData>;
  }
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      "OPEN_ROUTER_KEY" | "GITHUB_CLIENT_ID" | "GITHUB_CLIENT_SECRET"
    >
  > {}
}
